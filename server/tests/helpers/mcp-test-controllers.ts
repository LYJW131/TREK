...
export function createMcpTestRegistry(): McpRegistry {
  ...
  return createTestRegistry(
    [
      ...
      new TransitMcp(new TransitService(new GoogleTransitProvider(dbService), new AmapTransitProvider(dbService)), daysService, reservationsService, dbService, authService, guards),
