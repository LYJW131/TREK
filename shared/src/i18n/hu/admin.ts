...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider.amapHint':
    'A fenti Amap-kulcsot használja, Kína szárazföldi részéhez, ahol a Transitous-nak nincs adata. Az Amap indulási idők helyett utazási időtartamot ad vissza, ezért a megjelenített időpontok becslések.',
  'admin.transitProvider.amapNoKeyWarning':
    'A Amap van kiválasztva, de nincs beállítva Amap-kulcs – a közlekedési keresés továbbra is a Transitous-t használja. Adj hozzá kulcsot a fenti API-kulcsoknál.',
  'admin.transitProvider.amapPersonalKeyWarning':
    'Csak a saját Amap-kulcsod van beállítva, így a többi tag keresése továbbra is a Transitous-ra esik vissza. Mentsd a kulcsot fent adminként, hogy az egész példányra érvényes legyen.',
