...
const admin: TranslationStrings = {
  ...
  'admin.transitProvider.amapHint':
    'Χρησιμοποιεί το κλειδί Amap παραπάνω, για την ηπειρωτική Κίνα, όπου το Transitous δεν έχει δεδομένα. Το Amap επιστρέφει διάρκειες διαδρομής αντί για ώρες αναχώρησης, επομένως οι ώρες που εμφανίζονται είναι εκτιμήσεις.',
  'admin.transitProvider.amapNoKeyWarning':
    'Έχει επιλεγεί το Amap, αλλά δεν έχει ρυθμιστεί κλειδί Amap — η αναζήτηση μέσων μεταφοράς εξακολουθεί να χρησιμοποιεί το Transitous. Προσθέστε κλειδί στα Κλειδιά API παραπάνω.',
  'admin.transitProvider.amapPersonalKeyWarning':
    'Έχει οριστεί μόνο το δικό σας κλειδί Amap, οπότε η αναζήτηση των υπόλοιπων μελών επιστρέφει στο Transitous. Αποθηκεύστε το κλειδί παραπάνω ως διαχειριστής για να ισχύει σε όλη την εγκατάσταση.',
